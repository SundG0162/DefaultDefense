...
void EntityManager::init()
{
	...
	_allyMap.insert(std::make_pair(ALLY_TYPE::GREATSWORD, []() -> Ally* { return new Greatsword(ENTITY_TYPE::ALLY, "¡Ü", COLOR::MINT, 100000, 0, 300, 1500); }));
	_enemyMap.insert(std::make_pair(ENEMY_TYPE::GOBLIN, []() -> Enemy* { return new Goblin(ENTITY_TYPE::ENEMY, "¡ã", COLOR::GREEN, 10, 1000, 10); }));
	_enemyMap.insert(std::make_pair(ENEMY_TYPE::GOLDGOBLIN, []() -> Enemy* { return new GoldGoblin(ENTITY_TYPE::ENEMY, "¡ã", COLOR::YELLOW, 50, 5000, 100); }));
	_enemyMap.insert(std::make_pair(ENEMY_TYPE::OGRE, []() -> Enemy* { return new Ogre(ENTITY_TYPE::ENEMY, "¡á", COLOR::GREEN, 100, 500, 100); }));
